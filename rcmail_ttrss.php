...
class rcmail_ttrss extends rcube_plugin
{
   ...
   public $task = '?(?!login).*';
    ...
    function init()
    {
        ...
        // handler for sso requests sent by the rcmail_ttrss kolab_auth app
    ...
    function logout()
    {
        $rcmail = rcube::get_instance();
        $this->load_config();
        // send logout request to rcmail_ttrss
    ...
    function sso_request()
    {
        ...
        // if rcmail_ttrss sent a valid auth request, return plain username and password
